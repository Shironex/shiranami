  ...
  "targets": [
    {
      ...
      "sources": [
        ...
        "src/native/core/fft.cpp",
        "src/native/core/tempo.cpp",
        "src/native/core/key.cpp",
        "src/native/core/analysis.cpp",
        "src/native/waveform/waveform.cpp",
        "src/native/loudness/loudness.cpp",
        "src/native/analysis/analysis.cpp",
      ...
      "targets": [
        {
          ...
          "sources": [
            ...
            "src/native/test/test_fft.cpp",
            "src/native/test/test_tempo.cpp",
            "src/native/test/test_key.cpp"
          ],
