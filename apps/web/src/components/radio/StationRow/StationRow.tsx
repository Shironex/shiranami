  ...
  return (
    <div style={style} className="px-0.5">
      ...
      >
        ...
        <button
          onClick={onPlayClick}
          className="flex items-center gap-3 min-w-0 flex-1 rounded-lg focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-primary/40"
        >
          <div
            className={cn(
        ...
        <motion.button
          ...
          className={cn(
            ...
            'focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-primary/40 focus-visible:opacity-100',
            isFav
