...
function Slider({
  ...
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb className="block h-0 w-0 group-hover:h-3 group-hover:w-3 focus-visible:h-3 focus-visible:w-3 rounded-full bg-primary shadow-md shadow-primary/30 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 disabled:pointer-events-none disabled:opacity-50" />
    </SliderPrimitive.Root>
  );
}
