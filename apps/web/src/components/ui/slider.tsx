...
function Slider({
  ...
  return (
    ...
    >
      ...
      {/* The accessible name must land on the `role="slider"` element — Radix puts
          that role on the Thumb, not the Root. Forwarding the label here (instead
          of letting it sit on the unlabelled Root span) keeps axe's
          aria-input-field-name rule satisfied for every labelled slider. */}
